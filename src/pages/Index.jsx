    ...
    return (
        <motion.div
            ...
            <div className="beatslist">
                <Container>
                    <BeatList searchQuery={searchQuery} selectedBeat={selectedBeat} beatsToShow={10}
                    />
            ...
            <div className="page-bottom main-bg">
                ...
                <div className="contact-div">
                    <h2 className={'text-center text-white font-weight-bold'}>Contact me for mixing and mastering
                        orders.</h2>
