# Generated by Django 3.2.2 on 2021-06-13 15:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('license_type', models.CharField(choices=[('mp3', 'MP3 License'), ('wav', 'WAV License'), ('wtrackout', 'WAV + Trackouts'), ('exclusive', 'Exclusive License')], max_length=50)),
