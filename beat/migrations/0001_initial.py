# Generated by Django 3.2.2 on 2021-06-10 22:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('license_type', models.CharField(choices=[('mp3', 'MP3 Lease'), ('wav', 'WAV Lease'), ('full-body', 'Full Body Lease'), ('exclusive', 'Exclusive')], max_length=250)),
